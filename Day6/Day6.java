...
public class Day6 
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//*[@id=\"input-firstname\"]")).sendKeys("Padhu");
		driver.findElement(By.xpath("//*[@id=\"input-firstname\"]")).sendKeys("B");
		driver.findElement(By.xpath("//*[@id=\"input-email\"]")).sendKeys("padhu@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"input-password\"]")).sendKeys("Padhu@2003");
		...
		driver.findElement(By.xpath("//*[@id=\"first_name\"]")).sendKeys("Padhu");
		driver.findElement(By.xpath("//*[@id=\"last_name\"]")).sendKeys("B");
		driver.findElement(By.xpath("//*[@id=\"user_email\"]")).sendKeys("padhu@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"radio_1665627729_Male\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"user_pass\"]")).sendKeys("padhu@2003");
